...
public class EventInterceptor {
    ...
    public int getTypeId(InterceptEventType interceptEventType){
        switch (interceptEventType){
            case AMRegister: this.nodeType=1;break;
            case AMUnRegister: this.nodeType=2; break;
            case AllocateContainer: this.nodeType=3;break;
            case HeartbeatWith: this.nodeType=4;break;
            case CONTAINER_REMOTE_LAUNCH: this.nodeType=5;break;
            case CONTAINER_REMOTE_CLEANUP: this.nodeType=6;break;
